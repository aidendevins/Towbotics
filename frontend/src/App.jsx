  ...
  const carouselImages = [
    {
      ...
      title: 'Bolts Onto Your A-Frame',
      description: 'No modifications to your truck or trailer. The Towbot mounts directly through your existing A-frame opening and stays attached while you tow.',
      bg: '#f5f5f5',
      textDark: true,
    },
    {
      src: '/towbot-airstream.png',
      title: 'Solo Hitching, From Behind the Wheel',
      description: 'See exactly where your trailer is going. Use the remote to line up your hitch ball perfectly — no spotter, no guesswork, no back strain.',
      bg: '#f5f5f5',
      textDark: true,
    },
    {
      ...
      title: 'Built to Last',
      description: 'Precision-machined aluminium chassis, rubber track drive system, and a 650 lb-rated powered actuator. Engineered for driveways, campsites, gravel, and grass.',
      bg: '#000000',
      textDark: false,
    },
    {
      ...
      <section id="features" className="py-20 bg-slate-800">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            ...
            />
            <FeatureBlock
              title="Bolts On in Under an Hour"
              description="Replaces your existing tongue jack — no professional installer, no modifications to your truck or trailer frame, no drilling. Basic hand tools, standard A-frame opening, under 60 minutes. Once it's on, it stays on and tows with you."
            />
          </div>
